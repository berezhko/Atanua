...
#include "Vtwolatchverilog.h"
#include "verilated.h"


TwoLatchVerilog::TwoLatchVerilog()
{
    set(0,0,5,5,NULL);
    ...
    myff = new Vtwolatchverilog("Flipflop");
}

void TwoLatchVerilog::render(int aChipId)
{
	if (gBlackBackground)
...
void TwoLatchVerilog::update(float aTick) 
{

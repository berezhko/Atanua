...
#include "Vchip7432vlg.h"
#include "verilated.h"


Chip7432vlg::Chip7432vlg()
{
    ...
    chipImpl = new Vchip7432vlg();
}

void Chip7432vlg::render(int aChipId)
{
    drawtexturedrect(mTexture,mX,mY,mW,mH,0xffffffff);
    fn.drawstring("7432 VLG",mX+0.6,mY+0.6,0x5fffffff,0.75);
}

void Chip7432vlg::update(float aTick) 
{
